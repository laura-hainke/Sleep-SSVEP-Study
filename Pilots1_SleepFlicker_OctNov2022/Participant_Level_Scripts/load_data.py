...
# -*- coding: utf-8 -*-
"""
Step 1 - function to load CSV data of all conditions, 1 channel at a time; convert to numpy array
...
# =============================================================================
# Inputs: 
#   - file_name: 'EXG_flicker.csv' or 'EXG_blackout.csv' (to load file)
...
def load_data(file_name, condition):
    ...
    for chan in range(0,8): # loop through each channel and save the data
        ...
        # plot
        data = data - data.mean() # baseline-corrected
        plt.plot(data, label = chan)     
