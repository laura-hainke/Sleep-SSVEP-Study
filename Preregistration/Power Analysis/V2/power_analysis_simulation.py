...
# Own function for paired samples permutation
...
## Plot relation between the group mean difference and effect size
plt.figure()
...
exp_sample_1 = truncnorm.rvs(a=0, b=150, loc=35, scale=50, size=20, random_state=rng) # mean_exp = 35
con_sample_1 = truncnorm.rvs(a=0, b=150, loc=10, scale=50, size=20, random_state=rng) # mean_con = 10
...
# Plot aesthetics
plt.title('Power Curves', size=30, y=1.03)
